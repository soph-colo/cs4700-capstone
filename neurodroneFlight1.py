...
# main method that initalizes the communication between the headset and computer
async def main():
    ...
    # server intialization with parameters to received OSC to this device
    server = AsyncIOOSCUDPServer(("127.0.0.1", 8000), dispatcher, asyncio.get_event_loop())
    transport, protocol = await server.create_serve_endpoint()  # Create datagram endpoint and start serving

    # creat task that needs completed asyncronessly 
